...
export default function Contact() {
  ...
  const contacts = [
    ...
    {
      name: 'YouTube',
      description: 'Assista nossas produções',
      link: 'https://www.youtube.com/@usinadojet',
      color: 'hover:border-red-500 hover:shadow-[0_0_30px_-5px_rgba(239,68,68,0.3)]',
      icon: (
        <svg className="w-8 h-8 mb-4 text-zinc-300 group-hover:text-red-500 transition-colors" fill="currentColor" viewBox="0 0 24 24">
